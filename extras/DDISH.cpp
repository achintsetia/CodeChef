...
int calcNumbers( string numStr, int pivot, int length)
{
}

int getNumbers( string numStr)
{
  int length = numStr.size();
  cout << "L: " << length << endl;
  return calcNumbers( numStr, 0, length);
}
...
int main( int argc, char** argv)
{
  ...
  cin >> L;
cout <<   getNumbers( L) << endl;

//  while( T--)
//  {
//    cin >> L >> R;
//    cout << getNumbers( R) - getNumbers( L) + 1 << endl;
//  }
  return 0;
}
